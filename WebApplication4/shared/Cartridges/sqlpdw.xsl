...
(SELECT COALESCE(AuxTable.Op1 + CAST(AuxTable.Op2 AS float) +2, AuxTable.Op1, AuxTable.Op2) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op1Type = 'Datetime' and @Op1Nullable = 'false'">
(SELECT COALESCE(AuxTable.Op1 + AuxTable.Op2, AuxTable.Op1) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op1Type = 'Datetime'">
(SELECT COALESCE(AuxTable.Op1 + AuxTable.Op2, AuxTable.Op1, CAST(AuxTable.Op2 - 2 AS datetime)) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op2Type = 'Datetime' and @Op2Nullable = 'false'">
(SELECT COALESCE(AuxTable.Op1 + AuxTable.Op2, AuxTable.Op2) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op2Type = 'Datetime'">
(SELECT COALESCE(AuxTable.Op1 + AuxTable.Op2, CAST(AuxTable.Op1 - 2 AS datetime), AuxTable.Op2) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
...
(SELECT COALESCE(<xsl:apply-templates select="./*[1]"/> + AuxTable.Op2, AuxTable.Op2) FROM (SELECT <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:otherwise>
...
<xsl:choose>
<xsl:when test="@Op1Type = 'Datetime' and @Op2Type = 'Datetime'">
(SELECT COALESCE(AuxTable.Op1 - (CAST(AuxTable.Op2 AS float) +2), AuxTable.Op1, -2 - (AuxTable.Op2 + 2)) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op1Type = 'Datetime' and @Op1Nullable = 'false'">
(SELECT COALESCE(AuxTable.Op1 - AuxTable.Op2, AuxTable.Op1) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op1Type = 'Datetime'">
(SELECT COALESCE(AuxTable.Op1 - AuxTable.Op2, AuxTable.Op1, CAST(-2 - AuxTable.Op2 AS datetime)) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op2Type = 'Datetime' and @Op2Nullable = 'false'">
(SELECT COALESCE(-2 +(AuxTable.Op1-  (AuxTable.Op2 + 2)), -2 - (AuxTable.Op2 + 2)) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op2Type = 'Datetime'">
(SELECT COALESCE(-2 +(AuxTable.Op1-  (AuxTable.Op2 + 2)), CAST(AuxTable.Op1 - 2 AS datetime), -2 - (AuxTable.Op2 + 2)) FROM (SELECT <xsl:apply-templates select="./*[1]"/> AS Op1, <xsl:apply-templates select="./*[2]"/> AS Op2) as AuxTable)
</xsl:when>
<xsl:when test="@Op1Nullable = 'false' and @Op2Nullable = 'false'">
(<xsl:apply-templates select="./*[1]"/> - <xsl:apply-templates select="./*[2]"/>)
</xsl:when>
...
(SELECT
CASE
WHEN AuxTable.Op1 IS NULL THEN NULL
ELSE
CASE WHEN AuxTable.Op2 IS NULL OR AuxTable.Op2 = 0 THEN AuxTable.Op3 ELSE AuxTable.Op1 / AuxTable.Op2 END
END
...
<xsl:template match="OpWEEKNUM">DATEPART(WEEK, <xsl:apply-templates select="./*[1]"/>)</xsl:template>
<xsl:template match="OpWEEKDAY">DATEPART(WEEKDAY, <xsl:apply-templates select="./*[1]"/>)</xsl:template>
...
<!-- OpCase -->
<xsl:template match="OpCase">(CASE WHEN <xsl:apply-templates select="./Condition/*[1]"/> THEN <xsl:apply-templates select="./Then/*[1]"/> ELSE <xsl:apply-templates select="./Else/*[1]"/> END)</xsl:template>
