...
<xsl:when test="@Op1Type = 'Datetime'">COALESCE(<xsl:apply-templates select="./*[1]"/>, CAST(<xsl:value-of select="$TimestampStringForOriginDate"/> AS TIMESTAMP))</xsl:when>
...
<xsl:when test="@Op2Type = 'Datetime'">COALESCE(<xsl:apply-templates select="./*[2]"/>, CAST(<xsl:value-of select="$TimestampStringForOriginDate"/> AS TIMESTAMP))</xsl:when>
...
<xsl:variable name="DateStringForOriginDate">
'1899-12-30'
</xsl:variable>
<xsl:variable name="TimestampStringForOriginDate">
'1899-12-30 00:00:00.000'
</xsl:variable>
<xsl:variable name="TimestampStringForSQLBoolTrue">
'1899-12-31 00:00:00.000'
</xsl:variable>
<xsl:variable name="IntervalDayToSecondString">
'0000 00:00:01.000000'
</xsl:variable>
<!-- OpCast                                                             -->
<!-- Known types:                                                       -->
<!--     Double                                                         -->
